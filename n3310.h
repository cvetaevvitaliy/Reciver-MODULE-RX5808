...
// Распиновка порта
#define LCD_RST_set  PORTD |=  (1<<6)    //external reset input
#define LCD_RST_clr  PORTD &=~ (1<<6)

#define LCD_DC_set   PORTD |=  (1<<5)    //data/commande
#define LCD_DC_clr   PORTD &=~ (1<<5)

#define SDIN_set     PORTD |=  (1<<4)    //serial data input
#define SDIN_clr     PORTD &=~ (1<<4)

#define SCLK_set     PORTD |=  (1<<3)    //serial clock input
#define SCLK_clr     PORTD &= ~(1<<3)

 #define init_PORT_LCD    DDRD|= (1<<3)|(1<<4)|(1<<5)|(1<<6) 
